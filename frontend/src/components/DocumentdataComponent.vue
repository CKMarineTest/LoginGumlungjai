                  ...
                  <div class="w-full sm:w-1/1 lg:w-1/1 mt-2">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div class="relative">
                          ...
                          >
                            <button
                              @click="handleDownLoad(item.transcriptFilePath)"
                    ...
                    <div class="flex flex-wrap w-full gap-4 mt-2">
                      <div class="w-full sm:w-full lg:w-full">
                        <h3
                          class="text-xl font-semibold text-blue-900 mb-2 flex items-center"
                          for=""
                        >
                    ...
                    <div class="mx-auto px-1 mt-3">
                      <h3
                        class="text-xl font-semibold text-blue-900 mb-6 flex items-center"
                      >
                        ข้อมูลบิดา
                      </h3>
                      <div
                      ...
                      <div >
                        ...
                        <div class="p-4 sm:p-6">
                          <div
                            class="overflow-hidden border border-gray-200 rounded-lg shadow mb-6"
                          >
                            <table class="min-w-full divide-y divide-gray-200">
                              ...
                              <tbody class="bg-white divide-y divide-gray-200">
                                <tr
                                  v-for="(sibling, index) in siblingArray"
                                  :key="index.sb_id"
                      ...
                      <div class="p-2 sm:p-4 md:p-6 lg:p-8">
                        <div class="w-full max-w-6xl mx-auto relative">
                          <div
                            class="absolute -top-6 right-8 transform rotate-6 hidden md:block"
                          >
                            <div
                              class="w-20 h-24 bg-blue-100 rounded shadow-md flex items-center justify-center border-2 border-blue-200 relative"
                            >
                              <div
                                class="absolute inset-2 bg-white rounded"
                              ></div>
                              <div
                                class="absolute inset-4 flex flex-col space-y-2"
                              >
                          ...
                          <div class="overflow-hidden">
                            <div class="p-4 sm:p-6 md:p-8 relative">
                              ...
                              <div
                                ...
                                v-for="scholarship in dataArray"
                                :key="scholarship.idcard"
                              >
                                  ...
                                  <div class="w-full max-w-full mx-auto">
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <div
                                          class="absolute top-2 right-2 text-blue-200"
                                        >
                                          <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            class="w-6 h-6"
                                          ...
                                          >
                                            <path
                                              d="M12 3C3 3 3 12 3 12H12V3Z"
                                            />
                                            <path
                                              d="M12 12H21C21 12 21 3 12 3V12Z"
                                            />
                                            <path
                                              d="M12 21C21 21 21 12 21 12H12V21Z"
                                            />
                                            <path
                                              d="M12 12H3C3 12 3 21 12 21V12Z"
                                            />
                                          </svg>
                                        </div>
                      ...
                      <div
                        class="p-2 sm:p-4 md:p-6 lg:p-8 overflow-hidden relative"
                      >
                        <div
                        ...
                        >
                          ...
                          >
                            <svg
                              viewBox="0 0 100 100"
                              class="w-full h-full text-blue-700"
                            >
                              <rect
                                x="10"
                                y="20"
                      ...
                      <div class="">
                        <div class="absolute top-0 left-0 w-32 h-32 opacity-10">
                          ...
                          >
                            <path
                              d="M20,20 L80,20 L80,70 Q50,90 20,70 Z"
                              fill="currentColor"
                            />
                            <rect
                              x="25"
                        ...
                        <div class="w-full max-w-6xl mx-auto relative">
                          ...
                          <div class="mt-6 space-y-6">
                            <div class="group relative overflow-hidden">
                              <div
                                class="p-4 sm:p-6 flex flex-col sm:flex-row items-center gap-4"
                              >
                                <button
                                  @click="handleDownLoad(item.DocFile1Path)"
                                  class="inline-flex items-center gap-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 active:bg-blue-700 transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                                >
                                  <svg
                                    v-if="!selectedFile"
                                ...
                                <button
                                  @click="handleDownLoad(item.DocFile2Path)"
                                  class="inline-flex items-center gap-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 active:bg-blue-700 transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                                >
                                  <svg
                                    v-if="!selectedFile"
