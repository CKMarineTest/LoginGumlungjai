<template>
  <div class="min-h-screen bg-gradient-to-br from-indigo-100 via-blue-50 to-purple-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md animate-slideUp">
      <div class="bg-white py-8 px-6 shadow-2xl sm:rounded-2xl sm:px-10 border border-gray-100 relative overflow-hidden">
          ...
          <div class="mb-8 text-center">
            ...
            <h2 class="text-2xl font-semibold text-gray-900 relative">
              <span class="relative inline-block">
                เข้าสู่ระบบ
                <span class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-blue-400 to-indigo-500 transform scale-x-0 transition-transform duration-300 group-hover:scale-x-100"></span>
              </span>
            </h2>
          </div>
